...
class Gallery {
  ...
  public function SelItem ($input) { 
    ...
    $sql = "SELECT * FROM `gallery` WHERE `id` = '$input' LIMIT 1";
  ...
  public function NewItem ($title, $url, $category) {
    ...
    # La sentencia SQL permite realizar la cadena de lo que queremos consultar.
    $query = $con->query("INSERT INTO `gallery`(`title`, `url`, `category`) VALUES ('$title','$url','$category')");
  ...
  public function UpdItem ($id, $title, $url, $category) {
    ...
    # La sentencia SQL permite realizar la cadena de lo que queremos consultar.
    $sql = "UPDATE `posts` SET `title` = '$title', `category` = '$category''";
    # ", `category` = '$category'";
        
    # Chequeo que haya imagen.
    if($image != NULL) { $sql .= ", `url` = '$url'"; }
  ...
  public function DelItem ($input) { 
    ...
    # La sentencia SQL permite realizar la cadena de lo que queremos consultar.
    $sql = "DELETE FROM `gallery` WHERE `id` = '$input'";
...
class Categories {
  ...
  public function SelCategory ($input) { 
    ...
    # La sentencia SQL permite realizar la cadena de lo que queremos consultar.
    $sql = "SELECT * FROM `gallery_categories` WHERE `id` = '$input' LIMIT 1";
  ...
  public function NewCategory ($name, $shortcut) {
    ...
    # La sentencia SQL permite realizar la cadena de lo que queremos consultar.
    $query = $con->prepare("INSERT INTO `gallery_categories`(`name`, `shortcut`) VALUES (?,?)");
