...
<?php require ('mod/live.php'); ?>
<?php $con_live = new Live(); ?>
<?php $code = $con_live->SelCode()->fetch_array(); ?>
<!DOCTYPE html>
<html lang="es">
  <head>
    <title>Centro Familiar Cristiano - Una Iglesia de Excelencia</title>
    <meta charset="utf-8">
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="hero-wrap hero-wrap-3" style="background-image: url('vide/poster.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
					<div class="col-lg-12" id="embed-col"><?= $code['iframe'] ?></div>
        </div>
      </div>
    </section> <!-- .section -->
